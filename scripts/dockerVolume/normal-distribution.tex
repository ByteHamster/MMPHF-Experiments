...
\begin{tikzpicture}[trim axis left]
    \begin{axis}[
      ...
      %%   GROUP BY name
      %%   ORDER BY name,x
      \addplot[mark=x,color=colorCentroidHollowTrie,solid] coordinates { (5.5445,3.87357) };
      \addlegendentry{Centroid HT};
      \addplot[mark=pentagon,color=colorHollowTrie,solid] coordinates { (4.656055,3.57038) };
      \addlegendentry{Hollow};
      \addplot[mark=asterisk,color=colorHollowTrieDist,solid] coordinates { (4.69345,0.30266) };
      \addlegendentry{HTDist};
      \addplot[mark=square,color=colorHollowTrie,solid] coordinates { (4.53703,5.26759) };
      \addlegendentry{Hollow};
      \addplot[mark=rightTriangle,color=colorLcp,solid] coordinates { (12.8347,1.1484) };
      \addlegendentry{LCP};
      \addplot[mark=lemon,color=colorDirectRankStoring,solid] coordinates { (2.96967,9.48947) };
      \addlegendentry{\textbf{LeMonHash}};
      \addplot[mark=lemonVl,color=colorDirectRankStoring,solid] coordinates { (3.32322,2.19289) };
      \addlegendentry{\textbf{LeMonHash-VL}};
      \addplot[mark=|,color=colorPaCoTrieJava,solid] coordinates { (6.303848,1.17608) };
      \addlegendentry{PaCo};
...
\begin{tikzpicture}[trim axis left]
    \begin{axis}[
      ...
      %%   GROUP BY name
      %%   ORDER BY name,x
      \addplot[mark=x,color=colorCentroidHollowTrie,solid] coordinates { (5.5445,0.431742) };
      \addlegendentry{Centroid HT};
      \addplot[mark=pentagon,color=colorHollowTrie,solid] coordinates { (4.656055,0.360762) };
      \addlegendentry{Hollow};
      \addplot[mark=asterisk,color=colorHollowTrieDist,solid] coordinates { (4.69345,0.169704) };
      \addlegendentry{HTDist};
      \addplot[mark=square,color=colorHollowTrie,solid] coordinates { (4.53703,0.230776) };
      \addlegendentry{Hollow};
      \addplot[mark=rightTriangle,color=colorLcp,solid] coordinates { (12.8347,2.44021) };
      \addlegendentry{LCP};
      \addplot[mark=lemon,color=colorDirectRankStoring,solid] coordinates { (2.96967,2.57467) };
      \addlegendentry{\textbf{LeMonHash}};
      \addplot[mark=lemonVl,color=colorDirectRankStoring,solid] coordinates { (3.32322,1.71057) };
      \addlegendentry{\textbf{LeMonHash-VL}};
      \addplot[mark=|,color=colorPaCoTrieJava,solid] coordinates { (6.303848,0.733891) };
      \addlegendentry{PaCo};
